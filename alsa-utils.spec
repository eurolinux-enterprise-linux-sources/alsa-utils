...
# sample rate stuff
cd libsamplerate-%{sampleratever}
%configure CFLAGS="$RPM_OPT_FLAGS"
%{__make} %{?_smp_mflags}
cp src/.libs/libsamplerate.a ../alsaloop
cp src/samplerate.h ../alsaloop
cd ..
...
* Wed May  9 2012 Jaroslav Kysela <jkysela@redhat.com> 1.0.22-3
- Resolves: rbhz#674199

* Fri Mar  2 2012 Jaroslav Kysela <jkysela@redhat.com> 1.0.22-2
- updated to 1.0.22 final
- added alsaloop utility and alsa-delay script
- updated the alsa-info.sh script
- Resolves: rhbz#650113
